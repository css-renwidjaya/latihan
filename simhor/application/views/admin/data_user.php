                                                                        ...
                                                                        <table class="table data-list-view">
                                                                            ...
                                                                            <tbody>
                                                                                <?php foreach ($setting_tahun as $row) : ?>
                                                                                    <tr>
                                                                                        <td><input type="checkbox" class="checkstn" name="id_setting[]" value="<?php echo $row->id_setting ?>" /></td>
            ...
            <form id="formAdd" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama_madrasah" placeholder="Nama Madrasah">
                    </div>
                    <div class="form-group">
                        <label for="">Kecamatan</label>
                        <select name="code_kec" class="form-control select2">
                    ...
                    <div class="form-group">
                        <label>NSM</label>
                        <input type="text" class="form-control" name="nsm" placeholder="NSM">
                    </div>
                    <div class="form-group">
                        <label>NPSN</label>
