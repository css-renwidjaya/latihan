                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                    <img src="<?= base_url() ?>app-assets/images/pages/kemenag.png" alt="branding logo">
                                </div>
                                            ...
                                            <div class="card-body pt-1">
                                                <form action="<?php echo base_url() ?>admin/auth" method="post">
                                                    <fieldset class="form-label-group form-group position-relative has-icon-left">
                                                        <input type="text" class="form-control" id="user-name" name="username" placeholder="Masukan username" required>
